...
for row in calibration_data.index:
   calibration_data = calibration_data.loc[row]
   k = calibration_data.loc['strike_price']
   t = day_count.yearFraction(
       calculation_date, calibration_data['maturity_date'])
