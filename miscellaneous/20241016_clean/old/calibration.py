...
from pricing import heston_price_vanilla_row, heston_price_one_vanilla

def calibrate_model_row(self,row):
    """
    ...
    def objective_function(x):
        ...
        sigma = row['']
        rho = row['']
        option_prices = row['black_scholes']
        
        v0, kappa, theta, sigma, rho, lamba_ = x
        
        model_prices = heston_price_one_vanilla(w,calculation_date,strike_price,maturity_date,
