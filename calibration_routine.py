...
# lower_bound_strike = black_var_surface.minStrike()
# upper_bound_strike = black_var_surface.maxStrike()


option_data = option_data[option_data['strike_price'] > lower_bound_strike]
option_data = option_data[option_data['strike_price'] < upper_bound_strike]
