...
def generate_historical_barriers(s, calculation_date, g, heston_parameters):
    """
    up features
    """
    ...
    print(f"\n{training_data['barrier_price'].unique()}\n")
...
training_data = generate_historical_barriers(ms.s, ms.calculation_date, 0.005, heston_parameters)
